package com.github.sceneren.debounced.base
...
import com.github.sceneren.debounced.utils.ClassUtils
import com.github.sceneren.debounced.utils.DigestUtils
...
abstract class BaseTransform : Transform() {
    ...
    protected open fun onTransformEnd() {
        Log.printPluginEnd(System.currentTimeMillis() - startTime)
    }
    ...
    private fun forEachJar(
        ...
        FileUtils.copyFile(modifiedJar, destFile, false)
    }
